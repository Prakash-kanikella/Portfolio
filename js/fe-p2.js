document.addEventListener('DOMContentLoaded', () => {
    const pdimg1Image = document.getElementById('22'); // Select the image with id="11"
       ...
       <div class="popup-overlay" id="popupOverlay">
        <div class="popup-content">
          ...
          <div class="logo-container">
            <i class="fa fa-user-circle services-logo"></i>
            <h2>Personal Portfolio</h2>
          </div>
          
          <h3 class="left-subheading">Description</h3>
          <ul class="project-description">
            <li>Designed and developed a responsive personal portfolio website showcasing skills, projects, and achievements.</li>
            <li>Ensured a seamless user experience with intuitive navigation and modern design principles.</li>
          </ul>
